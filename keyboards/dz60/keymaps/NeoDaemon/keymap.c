...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_60_iso(
    ...
    _______, KC_CALC, KC_UP,   _______, _______, _______, KC_INS,  KC_HOME, KC_MS_U, KC_END,  KC_PGUP, KC_PSCR, KC_PAUS,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_DEL,  KC_MS_L, KC_MS_D, KC_MS_R, KC_PGDN, _______, _______, _______,
    _______, _______, _______, KC_APP,  _______, KC_BTN1, KC_BTN2, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
